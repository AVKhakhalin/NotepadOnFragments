...
public interface Constants {
    ...
    public final int DELTA_CHANGE_INT_ARRAYS = 10;
    // По-умолчанию, короткое название пустой записи
    public final String NAME_EMPTY_NOTE_ADD = "СОЗДАТЬ ЗАМЕТКУ";
    public final String NAME_EMPTY_NOTE = "НОВ.ЗАМ.";
    public final String DESCRIPTION_EMPTY_NOTE = "НОВАЯ ЗАМЕТКА";
